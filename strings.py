...
TRASH_EMPTY_VIEW      = "Wastebin is empty"
TRASH_LOAD_ERROR      = "Couldn't read the Wastebin: {msg}"
...
CONFIGURE_SYS_SMART_TITLE       = "SMART Drive Access"
CONFIGURE_SYS_SMART_LABEL       = (
    "SMART data requires disk group membership.\n"
    "Run the command below, then log out and back in."
)
CONFIGURE_SYS_SMART_CMD         = "sudo usermod -a -G disk $USER"
CONFIGURE_SYS_SMART_COPY_CMD    = "Copy command"
CONFIGURE_SYS_SMART_IN_GROUP    = "✓ In disk group (re-login if SMART still shows permission error)"
...
CONFIGURE_CAT_DASHBOARD     = "Dashboard"
CONFIGURE_DASH_VIEW_MODE    = "View mode:"
CONFIGURE_DASH_SIMPLE       = "Simple"
CONFIGURE_DASH_ADVANCED     = "Advanced"
DASHBOARD_TOGGLE_SIMPLE     = "Simple"
DASHBOARD_TOGGLE_ADVANCED   = "Advanced"
DASHBOARD_SCANNING          = "Scanning…"
DASHBOARD_RESCAN            = "↺ Rescan"
DASHBOARD_SMART_TITLE       = "Drive Health"
DASHBOARD_SMART_UNAVAILABLE = "Install smartmontools for drive health data."
DASHBOARD_SMART_NO_PERM     = "SMART needs disk-group access — see Configure → System."
DASHBOARD_SMART_HOWTO_BTN   = "How to enable"
DASHBOARD_SMART_HOWTO_TITLE = "Enabling SMART Access"
DASHBOARD_SMART_HOWTO_MSG   = (
    "Run this command, then log out and back in:\n\n"
    "    sudo usermod -a -G disk $USER\n\n"
    "Or visit Configure → System to copy the command."
)
DASHBOARD_SMART_PASSED      = "PASSED"
DASHBOARD_SMART_FAILED      = "FAILED"
